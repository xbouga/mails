...
if __name__ == "__main__":
    sender_email = "kontakd@medtkservdicegermany.de"
    sender_name = "𝗧𝗘𝗖𝗛𝗡𝗜𝗞𝗘𝗥 𝗞𝗥𝗔𝗡𝗞𝗘𝗡𝗞𝗔𝗦𝗦𝗘"
    subject = "Neues Medicare Kit: Jetzt gratis ausprobieren und profitieren!"
    message = read_html_file("message.html")

    with open("mails.txt", "r") as file:
        recipient_emails = [line.strip() for line in file.readlines()]

    to_email = "kontakd@medtkservdicegermany.dee"
